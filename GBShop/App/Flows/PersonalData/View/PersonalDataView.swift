...
class PersonalDataView: UIView {
    ...
    var logoutButton = ButtonDarkStyle()
    ...
    private func setupConstraints () {
        ...
        NSLayoutConstraint.activate([
            ...
            self.logoutButton.leadingAnchor.constraint(equalTo: usernameLabel.leadingAnchor, constant: 3*UIScreen.main.bounds.width/4),
            self.logoutButton.trailingAnchor.constraint(equalTo: usernameLabel.trailingAnchor),
            self.logoutButton.heightAnchor.constraint(equalTo: usernameLabel.heightAnchor, multiplier: 1),
        ])
    }
}
